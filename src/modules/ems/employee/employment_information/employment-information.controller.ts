...
export class EmploymentInformationController {
    ...
    async createEmploymentInformation(req: Request, res: ExpressResponse) {
        try {
            ...
            const { employee_id, department_id, designation_id, employee_type, employee_status } = req.body;
            
            if (!employee_id || !department_id || !designation_id || !employee_type || !employee_status) {
    ...
    async getEmploymentInformationByEmployeeId(req: Request, res: ExpressResponse) {
        try {
            ...
            const employmentInfo = await this.model.getEmploymentInformationByEmployeeId(Number(employeeId));
