...
leaveLimitRouter.get('/:employeeId', controller.getLeaveLimitByEmployeeId.bind(controller));
leaveLimitRouter.put('/:id', controller.updateLeaveLimitById.bind(controller));
leaveLimitRouter.delete('/:id', controller.deleteLeaveLimitById.bind(controller));
