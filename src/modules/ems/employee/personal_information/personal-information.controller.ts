...
; // Assuming you have this HttpStatus object
...
export class PersonalInformationController {
    ...
    async createPersonalInformation(req: Request, res: ExpressResponse) {
        try {
            const { employee_id, birthday, gender, phone, email, address_line, postal_code,
                emergency_contact_name, emergency_contact_phone, emergency_contact_relationship } = req.body;

            if (employee_id === undefined || birthday === undefined || gender === undefined || phone === undefined ||
                email === undefined || address_line === undefined || postal_code === undefined ||
                emergency_contact_name === undefined || emergency_contact_phone === undefined ||
    ...
    async getPersonalInformationByEmployeeId(req: Request, res: ExpressResponse) {
        try {
            ...
            const personalInfo = await this.model.getPersonalInformationByEmployeeId(Number(employeeId));
